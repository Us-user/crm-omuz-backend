...
**Общий прогресс:** Фаза 4 из 14 · 41 из 97 пунктов (~42%) — Фаза 0: 11/13 · **Фаза 1: 9/9 (закрыта)** · **Фаза 2: 8/8 (закрыта)** · Фаза 3: 9/10 (последний пункт ждёт журнала Фазы 5) · Фаза 4: 4/7
