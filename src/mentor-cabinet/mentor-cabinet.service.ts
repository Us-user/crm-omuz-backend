 ...
 *
 * Раздел «SMS mailings» из меню ТЗ 5.4 живёт **в модуле рассылок**
 * (`MentorMailingsController`, `/mentor/mailings`), а не здесь: это рассылка,
 * суженная своей группой, и «пункт меню, ведущий в модуль рассылок» — прямая
 * формулировка решения сессии 0023. Правила доступа те же, что у этого кабинета:
 * всё от токена, менторство вместо права каталога.
 */
@Injectable()
